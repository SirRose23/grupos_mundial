...
export default function MundialDashboard() {
    ...
    const renderContent = () => {
        switch (activeTab) {
            case 'confederaciones': return <ConfederacionView />
            case 'federaciones': return <FederacionView />
            case 'equipos': return <EquipoView />
            case 'grupos': return <GrupoView />
            default: return <EquipoView />
        }
    }
    ...
    return (
        <div className="min-vh-100 bg-light">
            ...
            <main className="container-fluid py-4 px-4">
                <div className="mb-4">
                    <h2 className="fw-bold text-dark text-capitalize">Gestión de {activeTab}</h2>
                </div>
